...
<body><div id="container">
	...
	<form action="tidviewstudent.php" method="POST"><br><h1>View Student:--</h1><br><br>
		<input type="text" name="id" placeholder="S ID" ><br>
...
if (isset($_POST['submit']))
{
	if(!$_POST['id'])
		{
			echo '<script>alert("PLEASE FILL THE STUDENT ID")</script>';
		}
	else{ 
				$sid=$_POST['id'];
